...
class Room
{
    ...
    public const MEDIUM_LEVEL = 'Moyen';
    public const HARD_LEVEL = 'Difficile';
    private int $id;
    private string $name;
    ...
    public function getNbEnigma() : int 
    {
        if ($this->niveau == Room::EASY_LEVEL) {
            return 5;
        }else if ($this->niveau == Room::MEDIUM_LEVEL){
            return 10;
        }else if ($this->niveau == Room::HARD_LEVEL){
            return 25;
        }
    }
